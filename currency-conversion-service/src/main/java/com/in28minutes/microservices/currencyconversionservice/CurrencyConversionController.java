...
public class CurrencyConversionController {
  ...
  public CurrencyConversionBean convertCurrency(@PathVariable final String from,
    ...
    final CurrencyConversionBean response = retrieveExchangeValueWithFeignProblem(from, to);
  ...
  private CurrencyConversionBean retrieveExchangeValueWithFeignProblem(final String from,
      final String to) {
    final Map<String, String> uriVariables = new HashMap<>();
    uriVariables.put("from", from);
    uriVariables.put("to", to);

    final CurrencyConversionBean response = new RestTemplate()
